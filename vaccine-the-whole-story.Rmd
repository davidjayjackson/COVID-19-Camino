---
title: "Spain: More Fun With Covid019 Vaccine"
author: "David Jackson"
date: "6/19/2021 02:36 PM/EDT"
...
df <- dbGetQuery(db,"select * from OWID where location ='Spain'")
...
ggplot(df) + geom_line(aes(x=date,y=total_vaccinations)) +
  ...
  labs(title="Spain total vaccinations Doses by Date",
...
ggplot(df) + geom_line(aes(x=date,y=people_vaccinated)) +
  scale_y_continuous(labels = comma) +
  labs(title="Spain Total People Vaccinated To Date",
...
ggplot(df) + geom_line(aes(x=date,y=people_fully_vaccinated)) +
  scale_y_continuous(labels = comma) +
  labs(title="Spain Total People Fully  Vaccinated To Date",
...
ggplot(df) + geom_line(aes(x=date,y=new_vaccinations)) +
  scale_y_continuous(labels = comma) +
  labs(title="Spain Daily People  Vaccinated by Date",
...
ggplot(df) + geom_line(aes(x=date,y=new_vaccinations_smoothed)) +
  scale_y_continuous(labels = comma) +
  labs(title="Spain Daily People  Vaccinated by Date",y="Daily Vaccinations (Smooth)",
...
ggplot(df) + geom_line(aes(x=date,y=total_vaccinations_per_hundred)) +
  scale_y_continuous(labels = comma) +
  labs(title="Spain Total Vaccinations Per Hundred",y="Daily Vaccinations (Per 100 People)",
...
ggplot(df) + geom_line(aes(x=date,y=people_vaccinated_per_hundred)) +
  scale_y_continuous(labels = comma) +
  labs(title="Spain People Vaccinated Per Hundred",y="People Vaccinated (per 100)",
...
ggplot(df) + geom_line(aes(x=date,y=people_fully_vaccinated_per_hundred)) +
  scale_y_continuous(labels = comma) +
  labs(title="Spain People Fully Vaccinated Per Hundred",y="People Vaccinated (per 100)",
