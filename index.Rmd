...
p5 <- ggplot(vac) + geom_line(aes(x=date,y=new_vaccinations)) +
  ...
  labs(title="Spain's Daily Doses By Date") 
...
p6 <- ggplot(vac) + geom_line(aes(x=date,y=total_vaccinations)) +
  scale_y_continuous(labels=comma) +
  labs(title="Spain's Total (Full) Doses Date") 
ggplotly(p6)
```
...
p5 <- ggplot(vac) + geom_line(aes(x=date,y=people_vaccinated)) +
  scale_y_continuous(labels=comma) +
  labs(title="Spain's Number of People Vaccinatations By Date") 
...
p6 <- ggplot(vac) + geom_line(aes(x=date,y=total_vaccinations)) +
  scale_y_continuous(labels=comma) +
  labs(title="Spain's Total  Number of People Fully Vaccinated By Date") 
ggplotly(p6)
