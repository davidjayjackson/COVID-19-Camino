...
plot(US$Reported,US$Cases,type="l",main=" COVID-19 Cases Apr. 1,2020 - Aug. 24, 2020",
...
summary(US$Deaths)
US$MA14 <- movingAverage(US$Cases,14)
plot(US$Reported,US$Cases,type="l",main=" COVID-19 Cases June. 1,2020 - Aug. 24, 2020",
     xlab="Date Reported",ylab="Cases")
lines(US$Reported,US$MA14,col="red")
grid(col="black")
```
```{r}
US <- subset(df,Reported >="2020-06-01" & Reported <="2020-08-24")
US$Deaths14 <- movingAverage(US$Deaths,14)
plot(US$Reported,US$Deaths,type="l",main="COVID-19 Deaths Apr. 1,2020 - Aug. 24, 2020",
     xlab="Date Reported",ylab="Deaths and 14 day Moving Averges(red)")
lines(US$Reported,US$Deaths14,col="red")
