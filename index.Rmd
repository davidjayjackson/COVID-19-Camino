...
# CAMINO$Cases <- ifelse(CAMINO$Cases ==-2461.0",2461,CAMINO$Cases)
# CAMINO$Cases <- ifelse(CAMINO$Cases =="-1430.0",1430,CAMINO$Cases)
# CAMINO$Cases <- ifelse(CAMINO$Cases =="-161.0",161,CAMINO$Cases)
# CAMINO$Cases <- ifelse(CAMINO$Cases =="-105.0",105,CAMINO$Cases)
# CAMINO$Cases <- ifelse(CAMINO$Cases =="-9",9,CAMINO$Cases)
## JHU Dat
