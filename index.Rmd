...
ECDC <- ECDC %>% filter(Cases >=0,Deaths>=0)
ECDC$Reported <- as.Date(ECDC$Reported)
ECDC$DeathRate <- ECDC$Deaths/ECDC$Cases
CAMINO <- ECDC %>% filter(Countries=="Spain" )
LEON <- ECDC %>% filter(Countries=="Portugal" )
## JHU Dat
